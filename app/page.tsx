...
export default function Home() {
  ...
  return (
    <main className="site-shell">
      ...
      <section id="about" className="section-pad about-section"><Reveal className="about-panel"><div className="about-badge"><Zap size={18} /> Independent research, practical outcomes</div><div className="about-layout"><div><h2>Security guidance<br /><span>without the theater.</span></h2></div><div className="about-copy"><p>Norivex Cyber is an independent practice founded by <strong>Connor Worthington</strong>, a cybersecurity student working toward the eJPT certification and building hands-on experience through real, responsible projects.</p><p>The approach is simple: ask permission, stay within scope, communicate clearly, and leave you with something useful.</p><a className="text-link" href="#contact">Meet over a quick call <ArrowUpRight size={16} /></a></div></div></Reveal></section>
